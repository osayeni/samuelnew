...
default_args = {
  ...
  'mqtt_broker' : '5e190661c5994a1bae3f1ca0e33abf31.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_finalprojectnew-00f8", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_finalprojectnew-00f8"], schedule=None,catchup=False)
